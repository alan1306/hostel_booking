            ...
            <ul><li class="User">HELLO
             <?php
               ...
               <div id="myDropdown" class="dropdown-content">
                ...
                <li><a href="contactpage2.html">CONTACT US</a></li>
              ...
              <div class="card">
                <a href="university.php">
                  <div style="background-image: url('sahara.jpg');"></div>
                    <span class="img-text">College Hostels</span>
...
<div class="card">
                <a href="private.php">
                  <div style="background-image: url('opal.jpg');" ></div>
                    <span class="img-text">Private Hostels</span>

</a>
</div>
<div class="card">
                <a href="#">
                  <div style="background-image: url('pana.png');" ></div>
                    <span class="img-text">Paying Guests</span>

</a>
</div>
<div class="card">
                <a href="#">
                  <div style="background-image: url('abad.jpg');"></div>
                    <span class="img-text">Flats</span>
